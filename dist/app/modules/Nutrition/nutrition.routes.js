...
router
    ...
    .post((0, auth_1.default)(client_1.UserRole.ADMIN), fileUploader_1.fileUploader.nutrition, (req, res, next) => {
    req.body = JSON.parse(req.body.data);
    next();
}, (0, validateRequest_1.default)(nutrition_validation_1.NutritiontValidation.NutritiontValidationSchema), nutrition_controller_1.NutritionController.createNutrition);
router
    .route("/:id")
    ...
    .put((0, auth_1.default)(client_1.UserRole.ADMIN, client_1.UserRole.USER), fileUploader_1.fileUploader.nutrition, (req, res, next) => {
    req.body = JSON.parse(req.body.data);
    next();
    ...
    .delete((0, auth_1.default)(client_1.UserRole.ADMIN, client_1.UserRole.USER), nutrition_controller_1.NutritionController.deleteNutrition);
